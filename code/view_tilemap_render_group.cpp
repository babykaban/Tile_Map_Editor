        ...
        )
    {
        ...
        switch(Header->Type)
        {
            ...
            case RenderGroupEntryType_render_entry_bitmap:
            {
                ...
                if(RenderGroup->RenderWithoutFetch)
                {
                    DrawFetchlessRect(OutputTarget, Entry->P, V2(Entry->Size.x, 0), V2(0, Entry->Size.y),
                                      Entry->Color, Entry->Bitmap, ClipRect, Even);
                }
                else
                {
...
AllocateRenderGroup(game_assets *Assets, memory_arena *Arena, uint32 MaxPushBufferSize,
                    b32 RendersInBackground, b32 RenderWithoutFetch)
{
    ...
    Result->RenderWithoutFetch = RenderWithoutFetch;
